...
namespace CognitiveSearch.UI
{
    ...
    public static partial class Extensions
    {
        public static SearchField ToSearchField(this Azure.Search.Documents.Indexes.Models.SearchField field)
        {
            ...
            else if (field.Type == SearchFieldDataType.Complex) type = typeof(Dictionary<string, SearchField>);//typeof(string);
            else if (field.Type == SearchFieldDataType.Collection(SearchFieldDataType.Complex)) type = typeof(Dictionary<string, SearchField>);//typeof(string);
